...
import { fetchUserDetails } from "@/store/reducer/user/viewUserDetailReducer";
import EmployeeLayout from "@/app/components/layouts/employeelayout/page";
import FeedbackCard from "../components/common/feedbackcard/page";
...
export default function Page() {
  ...
  useEffect(() => {
    if (userDetails?.user?.email) {
      dispatch(fetchFeedbacks(userDetails?.user?.email))
        .then((response) => {
